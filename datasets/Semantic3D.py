    ...
    def load_sub_sampled_clouds(self):
        ...
        if self.set in ['validation', 'test']:
            ...
            for i, file_path in enumerate(self.files):
                ...
                print(file_path, 'proj_inds', proj_inds.shape, 'labels',
                      labels.shape)
...
class Semantic3DSampler(Sampler):
    ...
    def __iter__(self):
        ...
        In this dataset, this is a dummy sampler that yield the index of batch element (inputsphere)
        in epoch instead of the list of point indices
        """
